              ...
              <div className="container">
                <div className="row gy-4">
                  <div className="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <p data-aos="fade-up" data-aos-delay="100">We deals in Top 50+ brands and provide upto 60% discount on top and latest fashion brands</p>
                  ...
                  <div className="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                    <img src="assets/img/images/p1.webp" className="img-fluid animated" alt="" />
                  </div>
                </div>
              </div>
            </section>
            ...
            <section id="hero" className="hero section">
              <div className="container">
                <div className="row gy-4">
                  ...
                  <div className="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                    <img src="assets/img/images/p2.webp" className="img-fluid animated" alt="" />
                  </div>
                </div>
              </div>
            </section>
            ...
            <section id="hero" className="hero section">
              <div className="container">
                <div className="row gy-4">
                  ...
                  <div className="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out">
                    <img src="assets/img/images/p3.webp" className="img-fluid animated" alt="" />
                  </div>
                </div>
              </div>
            </section>
