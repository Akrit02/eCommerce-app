            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary text-light p-2 text-center'>Update User<Link to="/admin/user"><i className='bi bi-arrow-left-circle text-light float-end'></i></Link></h5>
                        <form onSubmit={postData}>
                            <div className="row">
                                ...
                                <div className="col-md-6 mb-3">
                                    <label>Role</label>
                                    <select name="role" onChange={getInputData} value={data.role} className='form-control border-3 border-primary'>
                                ...
                                <div className="col-md-6 mb-3">
                                    <label>Active</label>
                                    <select name="active" onChange={getInputData} value={data.active} className='form-control border-3 border-primary'>
