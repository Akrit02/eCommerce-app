            ...
            <div className="container-fluid my-3">
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <h5 className='bg-primary text-light p-2 text-center'>Main Category <Link to="/admin/maincategory"><i className='bi bi-arrow-left-circle text-light float-end'></i></Link></h5>
                        <form onSubmit={postData}>
                            <div className="mb-3">
                                <label>Name</label>
                                <input type="text" name="name" onChange={getInputData} placeholder='Main-Category Name' className={`form-control border-3 ${show && errorMessage.name ? 'border-danger' : 'border-primary'}`} />
